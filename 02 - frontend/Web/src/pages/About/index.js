    ...
    <div className="container">
      ...
      <div className="descri">
        <h3>
          ...
          A tese faz parte de um projeto de pesquisa intitulado: "Internet das Coisas aplicada na Cadeia Produtiva do Agronegócio - Agricultura 4.0".                   
          </div>
